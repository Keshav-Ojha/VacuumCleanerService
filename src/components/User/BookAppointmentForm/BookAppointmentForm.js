...
function BookAppointmentForm(props) {
  ...
  async function handleOnSubmit(val) {
    val["user"] = { userId: userInfo.userId };
    val["center"] = {
      serviceCenterId: appointmentDetails.center.serviceCenterId,
    };
    val["paymentDone"] = false;
  ...
  const validate = Yup.object({
    ...
    purchaseDate: Yup.date()
      .max(new Date(), "select correct date")
      .required("Required"),
  ...
  return (
    <Formik
      ...
      initialValues={{
        ...
        productModelNo: appointmentDetails
          ? appointmentDetails.productModelNo
          : "",
        purchaseDate: appointmentDetails ? appointmentDetails.purchaseDate : "",
        problemStatement: appointmentDetails
          ? appointmentDetails.problemStatement
          : "",
      ...
      {(formik) => (
        <div className={styles.container}>
          ...
          <Form>
            ...
            />
            <TextField
              placeholder="click on select slot to choose date"
              type="text"
              name="bookingDate"
              label="Booking Date"
              readonly="true"
            />
            <TextField
              placeholder="click on select slot to choose time"
              type="text"
              name="bookingTime"
              label="Booking Time"
              readonly="true"
